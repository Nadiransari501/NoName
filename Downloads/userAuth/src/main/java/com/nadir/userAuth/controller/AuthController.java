...
public class AuthController {
    ...
    @Transactional
    public String processForgot(@RequestParam String email, HttpServletRequest request, Model model) {
        User user = userRepository.findByEmail(email);
        if (user == null) {
            model.addAttribute("error", "No user with this email");
            return "forgot-password";
        }
        ...
        mail.setText("Click to reset: " + resetUrl);
